    ...
    7: function (t, e, n) {
        ...
        var Y = {
            ...
            effect: function (t) {
                ...
                null != o &&
                    ...
                    ((e.elements.arrow = o), (e.modifiersData[i + "#persistent"] = { padding: F("number" != typeof a ? a : K(a, c)) }));
            },
        ...
        function V(t) {
            ...
            return h
                ? Object.assign(
                    Object.assign({}, O),
                    {},
                    (((A = {})[w] = v ? "0" : ""), (A[y] = b ? "0" : ""), (A.transform = (E.devicePixelRatio || 1) < 2 ? "translate(" + g + "px, " + _ + "px)" : "translate3d(" + g + "px, " + _ + "px, 0)"), A)
                )
                : Object.assign(Object.assign({}, O), {}, (((e = {})[w] = v ? _ + "px" : ""), (e[y] = b ? g + "px" : ""), (e.transform = ""), e));
        }
        var X = {
            name: "computeStyles",
            enabled: !0,
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    a = n.roundOffsets,
                    l = void 0 === a || a,
                    c = { placement: N(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: s };
                null != e.modifiersData.popperOffsets &&
                    (e.styles.popper = Object.assign(
                        Object.assign({}, e.styles.popper),
                        V(Object.assign(Object.assign({}, c), {}, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l }))
                    )),
                    null != e.modifiersData.arrow &&
                    (e.styles.arrow = Object.assign(Object.assign({}, e.styles.arrow), V(Object.assign(Object.assign({}, c), {}, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
                ...
                ? at(
                    (function (t) {
                        var e = x(t),
                            ...
                            r = 0,
                            a = 0;
                        return i && ((s = i.width), (o = i.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((r = i.offsetLeft), (a = i.offsetTop))), { width: s, height: o, x: r + st(t), y: a };
                    })(t)
                )
                : S(e)
                    ? (function (t) {
                    ...
                    : at(
                        (function (t) {
                            var e = R(t),
                                ...
                                r = -n.scrollLeft + st(t),
                                a = -n.scrollTop;
                            return "rtl" === M(i || e).direction && (r += Math.max(e.clientWidth, i ? i.clientWidth : 0) - s), { width: s, height: o, x: r, y: a };
                        })(R(t))
                    );
        }
        function ct(t, e, n) {
            var i =
                "clippingParents" === e
                    ? (function (t) {
                        var e = rt(B(t)),
                            n = ["absolute", "fixed"].indexOf(M(t).position) >= 0 && S(t) ? $(t) : t;
                        return C(n)
                            ? e.filter(function (t) {
        ...
        function ut(t, e) {
            ...
            var n = e,
                ...
                N = b === p ? j : x,
                P = { top: D.top - N.top + T.top, bottom: N.bottom - D.bottom + T.bottom, left: D.left - N.left + T.left, right: N.right - D.right + T.right },
                        ...
                        D = [O].concat(k).reduce(function (t, n) {
                            return t.concat(
                                N(n) === l
                                    ...
                                    })(e, { placement: n, boundary: v, rootBoundary: y, padding: b, flipVariations: T, allowedAutoPlacements: A })
                                    : n
                            );
                        }, []),
                        x = e.rects.reference,
        ...
        var mt = {
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    d = gt(l),
                    h = gt(c);
                (e.modifiersData[n] = { referenceClippingOffsets: l, popperEscapeOffsets: c, isReferenceHidden: d, hasPopperEscaped: h }),
                    (e.attributes.popper = Object.assign(Object.assign({}, e.attributes.popper), {}, { "data-popper-reference-hidden": d, "data-popper-escaped": h }));
            },
        };
        var _t = {
            name: "offset",
        ...
        var vt = {
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    v = n.tetherOffset,
                    y = void 0 === v ? 0 : v,
                    w = ut(e, { boundary: f, rootBoundary: p, padding: m, altBoundary: g }),
                    E = N(e.placement),
                    T = dt(e.placement),
                    A = !T,
                    O = U(E),
                ...
                if (k) {
                    if (c) {
                        var j = "y" === O ? s : a,
                            ...
                            V = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 },
                            X = V[j],
                            Q = V[I],
                            G = z(0, D[M], q[M]),
        ...
        function yt(t, e, n) {
            ...
            return (
                (a || (!a && !n)) &&
                (("body" !== D(e) || ot(o)) && (l = (i = e) !== x(i) && S(i) ? { scrollLeft: (s = i).scrollLeft, scrollTop: s.scrollTop } : it(i)), S(e) ? (((c = nt(e)).x += e.clientLeft), (c.y += e.clientTop)) : o && (c.x = st(o))),
        ...
        function At(t) {
            ...
            return function (t, e, n) {
                ...
                var s,
                    r,
                    a = { placement: "bottom", orderedModifiers: [], options: Object.assign(Object.assign({}, Et), o), modifiersData: {}, elements: { reference: t, popper: e }, attributes: {}, styles: {} },
                    l = [],
                    c = !1,
                    d = {
                        state: a,
                        setOptions: function (n) {
                            h(), (a.options = Object.assign(Object.assign(Object.assign({}, o), a.options), n)), (a.scrollParents = { reference: C(t) ? rt(t) : t.contextElement ? rt(t.contextElement) : [], popper: rt(e) });
                            var s = (function (t) {
                                var e = wt(t);
                        ...
                        forceUpdate: function () {
                            if (!c) {
                                var t = a.elements,
                                    ...
                                    n = t.popper;
                                if (Tt(e, n)) {
                                    (a.rects = { reference: yt(e, $(n), "fixed" === a.options.strategy), popper: P(n) }),
                                        (a.reset = !1),
        ...
        const ce = {
            ...
            trigger(t, e, n) {
                ...
                let a,
                    ...
                    h = null;
                return (
                    o && i && ((a = i.Event(e, n)), i(t).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (d = a.isDefaultPrevented())),
        ...
        const ge = {
            ...
            _e = ".bs.carousel",
            be = { interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0 },
        ...
        class Le extends de {
            ...
            _addEventListeners() {
                this._config.keyboard && ce.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
                    "hover" === this._config.pause && (ce.on(this._element, "mouseenter.bs.carousel", (t) => this.pause(t)), ce.on(this._element, "mouseleave.bs.carousel", (t) => this.cycle(t))),
            ...
            _addTouchEventListeners() {
                ...
                me.find(".carousel-item img", this._element).forEach((t) => {
                    ...
                    this._pointerEvent
                        ? (ce.on(this._element, "pointerdown.bs.carousel", (e) => t(e)), ce.on(this._element, "pointerup.bs.carousel", (t) => n(t)), this._element.classList.add("pointer-event"))
                        : (ce.on(this._element, "touchstart.bs.carousel", (e) => t(e)), ce.on(this._element, "touchmove.bs.carousel", (t) => e(t)), ce.on(this._element, "touchend.bs.carousel", (t) => n(t)));
            }
            _keydown(t) {
                    ...
                    if (((this._isSliding = !0), a && this.pause(), this._setActiveIndicatorElement(o), (this._activeElement = o), this._element.classList.contains("slide"))) {
                        ...
                        ce.one(i, "transitionend", () => {
                            o.classList.remove(c, d),
                                ...
                                (this._isSliding = !1),
                                setTimeout(() => {
                                    ce.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: h, from: s, to: r });
                                }, 0);
                        }),
                            It(i, t);
                    } else i.classList.remove("active"), o.classList.add("active"), (this._isSliding = !1), ce.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: h, from: s, to: r });
                    a && this.cycle();
                }
            }
            _directionToOrder(t) {
        ...
        ce.on(document, Oe, "[data-bs-slide], [data-bs-slide-to]", Le.dataApiClickHandler),
            ce.on(window, Ae, () => {
        ...
        class xe extends de {
            constructor(t, e) {
                super(t),
                    ...
                    (this._config = this._getConfig(e)),
                    (this._triggerArray = me.find(`[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`));
            ...
            show() {
                ...
                let t, e;
                this._parent &&
                    ((t = me.find(".show, .collapsing", this._parent).filter((t) => ("string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains("collapse")))),
                        0 === t.length && (t = null));
        ...
        const Ce = new RegExp("ArrowUp|ArrowDown|Escape"),
            ...
            He = { offset: [0, 2], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, autoClose: !0 },
            Re = { offset: "(array|string|function)", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)", autoClose: "(boolean|string)" };
        class Be extends de {
            constructor(t, e) {
            ...
            show() {
                ...
                if (!ce.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                    ...
                    "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t) => ce.on(t, "mouseover", Wt)),
                        this._element.focus(),
            ...
            _completeHide(t) {
                ce.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
                    ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t) => ce.off(t, "mouseover", Wt)),
            ...
            _getConfig(t) {
                if (
                    ((t = { ...this.constructor.Default, ...ge.getDataAttributes(this._element), ...t }),
                        Mt("dropdown", t, this.constructor.DefaultType),
                        "object" == typeof t.reference && !Pt(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
                )
        ...
        ce.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', Be.dataApiKeydownHandler),
            ...
            ce.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', function (t) {
        ...
        const We = () => {
            ...
            Ye = { isVisible: !0, isAnimated: !1, rootElement: document.body, clickCallback: null },
            qe = { isVisible: "boolean", isAnimated: "boolean", rootElement: "element", clickCallback: "(function|null)" };
        class Ve {
            constructor(t) {
            ...
            show(t) {
                ...
                this._isShown ||
                    ...
                    ((this._isShown = !0),
                        ...
                        ce.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (t) => this.hide(t)),
        ...
        class sn extends de {
            ...
            show(t) {
                ...
                (this._isShown = !0),
                    ...
                    this._backdrop.show(),
                    this._config.scroll || ($e(), this._enforceFocusOnElement(this._element)),
                    this._element.removeAttribute("aria-hidden"),
                    this._element.setAttribute("aria-modal", !0),
                    this._element.setAttribute("role", "dialog"),
                    this._element.classList.add("show");
            ...
            _addEventListeners() {
                ce.on(this._element, "click.dismiss.bs.offcanvas", '[data-bs-dismiss="offcanvas"]', () => this.hide()),
        ...
        const hn = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
            ...
            pn = { AUTO: "auto", TOP: "top", RIGHT: zt() ? "left" : "right", BOTTOM: "bottom", LEFT: zt() ? "right" : "left" },
            gn = {
                animation: !0,
        ...
        class _n extends de {
            ...
            dispose() {
                clearTimeout(this._timeout),
                    ce.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler),
            ...
            show() {
                ...
                qt.set(i, this.constructor.DATA_KEY, this),
                    this._element.ownerDocument.documentElement.contains(this.tip) || (a.appendChild(i), ce.trigger(this._element, this.constructor.Event.INSERTED)),
                    this._popper ? this._popper.update() : (this._popper = Lt(this._element, i, this._getPopperConfig(r))),
            ...
            setElementContent(t, e) {
                if (null !== t)
                    return "object" == typeof e && Pt(e)
                        ...
                        : void (this.config.html ? (this.config.sanitize && (e = dn(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
            }
            getTitle() {
            ...
            _setListeners() {
                this.config.trigger.split(" ").forEach((t) => {
                    if ("click" === t) ce.on(this._element, this.constructor.Event.CLICK, this.config.selector, (t) => this.toggle(t));
                    else if ("manual" !== t) {
                    ...
                    ce.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler),
            ...
            _getConfig(t) {
                ...
                return (
                    ...
                    t.sanitize && (t.template = dn(t.template, t.allowList, t.sanitizeFn)),
                    t
                );
            }
            _getDelegateConfig() {
        ...
        class On extends de {
            constructor(t, e) {
                super(t),
                    ...
                    ce.on(this._scrollElement, "scroll.bs.scrollspy", () => this._process()),
                    this.refresh(),
                    this._process();
            }
            static get Default() {
            ...
            _activate(t) {
                ...
                n.classList.contains("dropdown-item")
                    ? (me.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active"))
                    : (n.classList.add("active"),
                        me.parents(n, ".nav, .list-group").forEach((t) => {
                            me.prev(t, ".nav-link, .list-group-item").forEach((t) => t.classList.add("active")),
