                            ...
                            t.exports = (function () {
                                var t = "millisecond",
                                    ...
                                    d = {
                                        ...
                                        p: function (h) {
                                            return (
                                                { M: o, y: u, w: s, d: i, h: r, m: e, s: n, ms: t, Q: a }[h] ||
                                                String(h || "")
                                                    .toLowerCase()
                                                    .replace(/s$/, "")
                                            );
                                    ...
                                    return (
                                        ...
                                        (d.diff = function (t, h, f) {
                                            var c,
                                                ...
                                                M = g.m(this, l);
                                            return (
                                                (M = ((c = {}), (c[u] = M / 12), (c[o] = M), (c[a] = M / 3), (c[s] = ($ - m) / 6048e5), (c[i] = ($ - m) / 864e5), (c[r] = $ / 36e5), (c[e] = $ / 6e4), (c[n] = $ / 1e3), c)[d] || $),
                                                f ? M : g.a(M)
                                            );
                                        }),
            ...
            2: [
                function (require, module, exports) {
                    ...
                    const isObject = (t) => "[object Object]" === Object.prototype.toString.call(t),
                        ...
                        button = (t, e, s) => createElement("li", { class: "page-item " + t, html: `<a href="#" class="page-link" data-page="${e}">${s}</a>` }),
                        sortItems = (t, e) => {
                            let s, a;
                        ...
                        order(t) {
                            ...
                            t.forEach((t, a) => {
                                (n = o.headings[t]),
                                    ...
                                    (e.sortable = l),
                                    h[0].push(e),
                                    o.hiddenColumns.includes(t) || (((s = n.cloneNode(!0)).originalCellIndex = a), (s.sortable = l), h[1].push(s));
                            }),
                                o.data.forEach((e, s) => {
                                    (a = e.cloneNode(!1)),
                                        (i = e.cloneNode(!1)),
                            ...
                            Promise.all(c).then((i) => {
                                ...
                                Array.from(n).forEach((e) => {
                                    ...
                                    (i = c ? c(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a),
                                        parseFloat(i) == i ? (r[o++] = { value: Number(i), row: e }) : (l[h++] = { value: "string" == typeof a ? a.toLowerCase() : a, row: e });
                                }),
                                    e || (e = d.classList.contains("asc") ? "desc" : "asc"),
                                    "desc" == e
                                        ? ((p = sortItems(l, -1)), (u = sortItems(r, -1)), d.classList.remove("asc"), d.classList.add("desc"))
                                        : ((p = sortItems(r, 1)), (u = sortItems(l, 1)), d.classList.remove("desc"), d.classList.add("asc")),
                                    a.lastTh && d != a.lastTh && (a.lastTh.classList.remove("desc"), a.lastTh.classList.remove("asc")),
                                    (a.lastTh = d),
                                    (n = p.concat(u)),
                                    (a.data = []);
                                const g = [];
                    ...
                    class DataTable {
                        constructor(t, e = {}) {
                            if (
                                ((this.initialized = !1),
                                    (this.options = { ...defaultConfig, ...e, layout: { ...defaultConfig.layout, ...e.layout }, labels: { ...defaultConfig.labels, ...e.labels } }),
                        ...
                        render(t) {
                                        ...
                                        if (4 === s.readyState)
                                            if ((this.emit("datatable.ajax.loaded", e, s), 200 === s.status)) {
                                                ...
                                                (a.data = t.load ? t.load.call(this, s) : s.responseText),
                                                    (a.type = "json"),
                                                    t.content && t.content.type && ((a.type = t.content.type), Object.assign(a, t.content)),
                                                    this.import(a),
                                                    this.setColumns(!0),
                            ...
                            if (
                                ((this.body = this.table.tBodies[0]),
                                    ...
                                    this.body || ((this.body = createElement("tbody")), this.table.appendChild(this.body)),
                            ...
                            if (
                                ((this.headings = []),
                                    ...
                                    e.footer ? this.head && !this.foot && ((this.foot = createElement("tfoot", { html: this.head.innerHTML })), this.table.appendChild(this.foot)) : this.foot && this.table.removeChild(this.table.tFoot),
                                    (this.wrapper = createElement("div", { class: "dataTable-wrapper dataTable-loading" })),
                                ...
                                let t = "<div class='dataTable-dropdown'><label>Hiển thị</label>";
                                (t += e.labels.perPage), (t += "<label>mục</label></div>");
                        ...
                        renderPage() {
                            ...
                            let t,
                                ...
                                a = 0;
                            if (
                                (this.totalPages && ((a = (s = (e = this.currentPage - 1) * this.options.perPage) + this.pages[e].length), (s += 1), (t = this.searching ? this.searchData.length : this.data.length)),
                        ...
                        fixColumns() {
                            if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                                ...
                                if (((this.columnWidths = []), this.table.tHead)) {
                                    if (
                                        (this.options.scrollY.length && ((e = createElement("thead")).appendChild(createElement("tr")), (e.style.height = "0px"), this.headerTable && (this.table.tHead = this.headerTable.tHead)),
                                ...
                                ((t = t.toLowerCase()),
                                    ...
                                    t.length
                                        ? (this.clear(),
                                            ...
                                            this.searchData.length ? this.update() : (this.wrapper.classList.remove("search-results"), this.setMessage(this.options.labels.noRows)),
                        ...
                        export(t) {
                            ...
                            const h = { download: !0, skipColumn: [], lineDelimiter: "\n", columnDelimiter: ",", tableName: "myTable", replacer: null, space: 4, ...t };
                            if (h.type) {
                                ...
                                if (s.length) {
                                    if ("txt" === h.type || "csv" === h.type) {
                                        ...
                                        for (l = `INSERT INTO \`${h.tableName}\` (`, i = 0; i < e.length; i++)
                        ...
                        import(t) {
                            ...
                            if (s.data.length || isObject(s.data)) {
                                if ("csv" === s.type) {
                                    ...
                                    t.length &&
                                        (s.headings && ((e.headings = t[0].split(s.columnDelimiter)), t.shift()),
                                            t.forEach((t, a) => {
                                                e.data[a] = [];
                        ...
                        setMessage(t) {
                            ...
                            this.hasRows ? (e = this.data[0].cells.length) : this.activeHeadings.length && (e = this.activeHeadings.length),
                                ...
                                (this.totalPages = 0),
                                this.render("pager"),
                                this.clear(createElement("tr", { html: `<td class="dataTables-empty" colspan="${e}">${t}</td>` }));
                        }
                        columns(t) {
